...
export const employmentIntakeSchema = z.object({
  ...
  is_federal: optBool,
  worker_classification: optString,
  de_facto_employee: optBool,
  other_clients: optBool,
  contract_type: optString,
  is_probationary: optBool,
  probation_length_months: optNumber,
  terminated_within_probation: optBool,
  has_term_clause: optBool,
  clause_has_cause: optBool,
  cause_standard: optString,
  clause_specifies_notice: optBool,
  clause_limits_to_esa: optBool,
  clause_has_saving: optBool,
  clause_benefits_continuation: optBool,
  clause_at_any_time: optBool,
  clause_constructive_dismissal: optBool,
  no_fresh_consideration: optBool,
  had_ila: optBool,
  ...
  cd_advance_notice: optBool,
  cd_accepted: optBool,
  cd_delay_weeks: optNumber,
  cd_code_linked: optBool,
  age_at_termination: optNumber,
  job_level: optString,
  ...
  no_gap_successor: optBool,
  formal_sale: optString,
  service_expressly_negated: optBool,
  received_term_pay: optBool,
  benefits_continued: optBool,
  vacation_paid: optBool,
  ...
  hrc_harassment: optBool,
  adverse_after_complaint: optBool,
  pregnancy_leave_factor: optBool,
  ...
  ohsa_concern_raised: optBool,
  ohsa_work_refusal: optBool,
  ohsa_jhsc: optBool,
  workplace_violence: optBool,
  ohsa_harassment_reported: optBool,
  on_leave_at_termination: optBool,
  release_ila_time: optBool,
  insolvency_concern: optBool,
  actively_mitigating: optBool,
  found_new_employment: optBool,
  new_employment_details: optString,
  employer_offered_reemployment: optBool,
  received_ei: optBool,
  received_cerb: optBool,
  additional_info: optString,
