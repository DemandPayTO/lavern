...
export function houseFormContext(args: {
  ...
  const parts: string[] = [
    ...
    '',
    'Rules:',
    '- Reproduce the standard passages word for word, changing only what the facts of this file require. Do not improve, shorten, modernise or reorder them.',
    '- Where a passage carries a [SLOT], put this matter\'s value in and leave the rest of the sentence exactly as written.',
    '- Where the firm\'s standard language does not fit this file, do not force it: leave it out and write what the file needs, then say so in one sentence under a final heading "Note to the lawyer".',
