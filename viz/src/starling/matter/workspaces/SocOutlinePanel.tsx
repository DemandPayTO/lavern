            ...
            {isOpen && (hasText || s.kind === 'node') && (
              <div style={{ marginTop: 8, marginLeft: 96 }}>
                ...
                {isEditing ? (
                  ...
                  <>
                    <DocumentHtml style={{ fontSize: 12.5, color: ink, lineHeight: 1.55, background: '#fbfaf7', border: `1px solid ${border}`, borderRadius: 2, padding: '10px 12px', maxHeight: 300, overflowY: 'auto' }} html={s.html} />
